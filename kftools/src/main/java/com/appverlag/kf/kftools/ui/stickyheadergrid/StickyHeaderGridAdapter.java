package com.appverlag.kf.kftools.ui.stickyheadergrid;
...
public abstract class StickyHeaderGridAdapter extends RecyclerView.Adapter<StickyHeaderGridAdapter.ViewHolder> {
   ...
   final public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      ...
      final int externalType = externalViewType(viewType);
       ...
       return switch (internalType) {
           case TYPE_HEADER -> onCreateHeaderViewHolder(parent, externalType);
           case TYPE_ITEM -> onCreateItemViewHolder(parent, externalType);
           default -> throw new InvalidParameterException("Invalid viewType: " + viewType);
       };
   }
   ...
   final public int getItemViewType(int position) {
      ...
      int externalType = switch (internalType) {
          case TYPE_HEADER -> getSectionHeaderViewType(section);
          case TYPE_ITEM -> getSectionItemViewType(section, sectionPosition - 1);
          default -> 0;
      };
