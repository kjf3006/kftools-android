...
RE.editor.addEventListener("focus", function() {
    RE.backuprange();
    window.webkit.messageHandlers.didBeginEditing.postMessage("");
});

RE.editor.addEventListener("blur", function() {
    window.webkit.messageHandlers.didEndEditing.postMessage("");
});
...
RE.callback = function(method) {
    window.webkit.messageHandlers.log.postMessage(method);
};


RE.textDidChange = function(method) {
    window.location.href = "textdidchange://" + encodeURI(RE.getHtml());
};


RE.focus = function() {
    return RE.editor.focus();
};
...
RE.setHtml = function(contents) {
    ...
    tempWrapper.innerHTML = decodeURIComponent(contents.replace(/\+/g, '%20'));
...
RE.setDefaultTextColor = function(color) {
...
//    el.setAttribute("href", "http://google.de");
//    el.setAttribute("title", "title");
//    el.innerHTML = "title";
    
//    var di = document.createElement("div");
//    di.innerHTML = '<a href="www.google.com">google</a>';
//    
//    window.webkit.messageHandlers.log.postMessage("test");
//    
//    var sel, range;
...
//    window.webkit.messageHandlers.log.postMessage("start_inserting");
//    RE.restorerange();
//    var sel = document.getSelection();
//    window.webkit.messageHandlers.log.postMessage("selection: " + sel.toString());
